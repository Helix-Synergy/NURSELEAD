  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path= "/nurselead-orators"   element={<Orators />} />
        <Route path="/about-nurselead" element={<AboutOralMed />} />
        <Route path="/nurselead-event-schedule"element={<EventSchedule />} />
        <Route path="/venue" element={<Venue/>}/>
        <Route path="/contact" element={<ContactForm />} />
        <Route path="/nurselead-conference-tracks/" element={<RotatingLogos />} />
